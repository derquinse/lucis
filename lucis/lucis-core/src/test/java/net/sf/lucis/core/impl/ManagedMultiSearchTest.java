...
public class ManagedMultiSearchTest {
	...
	public void queryables() {
		this.queryableRAM = Queryables.managed(ram);
		this.queryableRAM2 = Queryables.managed(ram2);
		this.queryableFS = Queryables.managed(fs);
